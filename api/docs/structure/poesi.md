...
Ce document décrit le **canon initial** (v1).  
Il accompagne des fichiers JSON d’archive.
...
L’Œuf incarne l’attente et le potentiel.  
Il correspond à l’état neutre, avant l’éclosion.

---

### Totems fondateurs

- **Moineau** — sincérité, simplicité, voix basse
- **Chouette** — lucidité, analyse, précision
- **Faucon** — tension maîtrisée, frappe nette
- **Corbeau** — gravité, profondeur, traversée de l’ombre
- **Perroquet** — musicalité, répétition, vibration
- **Cygne** — grâce, harmonie, fluidité
