...
| CannotVote\CannotVoteTwiceException (optional)   | 409  | DUPLICATE_VOTE            | conflict  | Prevent same user voting twice |
| Canon\ImmutableCanonException                    | 409  | CANON_IMMUTABLE           | conflict  | Attempt to modify initial canon |
